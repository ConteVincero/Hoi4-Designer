...
namespace Hoi4_Designer
{
    class Tank_Designer
    {
        ...
        public List<Module> GetModules()
        {
            ...
            string Chassis_File = Hoi4_Designer.Properties.Resources.GamePath + "common/units/equipment/tank_chassis.txt";
        ...
        {//Go through the research files and update the year scores for chassis and modules
            string researchDir = Properties.Resources.GamePath + "common\\technologies";
